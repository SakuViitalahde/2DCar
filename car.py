...
class Car:
    def __init__(self,screen):
        ...
        self.back_wheel =  pygame.math.Vector2(80,200)
        self.front_wheel = pygame.math.Vector2(80,230)
    ...
    def refresh(self):
        ...
        wheel_for_collision = []
        wheel_for_collision.append(pygame.draw.circle(self.screen, (100,0,0), self.back_wheel, 10))
        wheel_for_collision.append(pygame.draw.circle(self.screen, (100,0,0), self.front_wheel, 10))
        self.wheel_collision = wheel_for_collision
    ...
    def calculate_movement(self):
        ...
        back_wheel_miss_movement = self.back_wheel.distance_to(self.front_wheel)
        if self.speed > 0:
